...
export class MailService {
  ...
  constructor(private configService: ConfigService) {
    ...
    if (!mailHost || !mailPortString || !mailUser || !mailPassword) {
      this.logger.warn(
        'Mail configuration is incomplete. Mail service will be disabled. Please check .env file for MAIL_HOST, MAIL_PORT, MAIL_USER, MAIL_PASSWORD.',
      );
      return; // Don't throw error, just disable mail service
    }
