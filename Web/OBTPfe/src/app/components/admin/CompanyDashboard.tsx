      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-2">
              <button className="px-3 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-lg text-sm">
                {t("days7")}
              </button>
              <button className="px-3 py-1 text-gray-600 dark:text-gray-400 rounded-lg text-sm hover:bg-gray-50 dark:hover:bg-gray-700">
                {t("days30")}
              </button>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-700">
            <h3 className="text-gray-900 dark:text-white">Chuyến Đi Gần Đây</h3>
          </div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div className="w-24 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${(trip.booked / trip.total) * 100}%`,
                            }}
                          ></div>
                        </div>
                      </div>
