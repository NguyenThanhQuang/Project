    ...
    <div className="fixed inset-0 bg-black z-50">
      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute top-1/4 left-0 right-0 text-center px-6">
          ...
          <p className="text-white/70 text-sm">Giữ camera ổn định để quét</p>
        </div>
        ...
        {showManualInput && (
          <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-gray-900 rounded-t-3xl p-6 shadow-2xl">
            <h3 className="text-gray-900 dark:text-white mb-4">Nhập Mã Vé</h3>
        ...
        {scanResult && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div
              className={`bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-2xl mx-4 ${
                scanResult === "success"
                ...
                <>
                  ...
                  {passengerInfo && (
                    <p className="text-gray-600 dark:text-gray-400 text-center">
                      {passengerInfo.name} - Ghế {passengerInfo.seat}
                    </p>
                  )}
                </>
              ) : (
