...
type Screen = 'login' | 'register' | 'home' | 'trip-detail' | 'qr-scanner' | 'profile' | 'profile-detail' | 'navigation' | 'trip-history' | 'earnings' | 'notifications' | 'change-password' | 'achievements' | 'settings';
...
export function DriverApp({ onLogout }: DriverAppProps = {}) {
  ...
  const handleLoginSuccess = (data: { name: string; id: string; phone: string }) => {
    setDriverData(data);
