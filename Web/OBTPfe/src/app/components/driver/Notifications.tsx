  ...
  const [notificationsList, setNotificationsList] = useState<Notification[]>([
    {
      ...
      message:
        "Bạn đã hoàn thành chuyến TP.HCM → Đà Lạt lúc 14:30. Đánh giá: 5.0⭐",
      time: "5 phút trước",
      read: false,
      details:
        "Chuyến đi TP.HCM → Đà Lạt đã hoàn thành xuất sắc. Thời gian: 6 giờ 30 phút. Khoảng cách: 308km. Số hành khách: 38/40. Doanh thu: 11,000,000đ. Khách hàng đã đánh giá 5 sao và để lại nhận xét tích cực về thái độ phục vụ chuyên nghiệp của bạn.",
    },
    {
      id: "2",
      type: "info",
      ...
      message:
        "Bạn đã được phân công chuyến Đà Lạt → TP.HCM vào 16:00 ngày mai",
      time: "1 giờ trước",
      read: false,
      details:
    ...
    },
    {
      ...
      message:
        "Bằng lái xe của bạn sẽ hết hạn vào 15/08/2025. Vui lòng gia hạn sớm.",
      time: "1 tuần trước",
      read: true,
      details:
      ...
      {selectedNotification && (
        <>
          ...
          <div className="fixed inset-x-4 top-1/2 -translate-y-1/2 max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-3xl shadow-2xl z-50 animate-scale-in max-h-[80vh] overflow-hidden flex flex-col">
            <div
              className={`p-6 border-b border-gray-200 dark:border-gray-700 ${getBackgroundColor(
          ...
          {filteredNotifications.map((notification) => (
            ...
            >
              <div className="p-5">
                <div className="flex items-start space-x-4">
                  <div
                    className={`p-3 rounded-xl ${getBackgroundColor(
                      notification.type
                    )}`}
                  >
