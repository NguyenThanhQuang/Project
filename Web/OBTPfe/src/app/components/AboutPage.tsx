...
export function AboutPage({ onBack }: AboutPageProps) {
  ...
  const stats = [
    ...
    {
      icon: MapPin,
      labelKey: "routesCount",
      value: "500+",
      color: "from-green-600 to-green-500",
    },
    {
      icon: TrendingUp,
      labelKey: "partnerCompanies",
      value: "200+",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`inline-flex p-4 bg-gradient-to-r ${stat.color} rounded-2xl mb-4`}
                >
                  <Icon className="w-8 h-8 text-white" />
                </div>
                <p className="text-4xl text-gray-900 dark:text-white mb-2">
                  {stat.value}
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`inline-flex p-4 bg-gradient-to-r ${value.color} rounded-2xl mb-4`}
                  >
                    <Icon className="w-8 h-8 text-white" />
                  </div>
                ...
                >
                  ...
                  >
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-200 dark:border-gray-700 hover:scale-105 transition-transform">
                      ...
                      <h3 className="text-xl text-gray-900 dark:text-white mt-2 mb-2">
                        {t(item.titleKey)}
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        {t(item.descKey)}
        ...
        <div className="bg-gradient-to-r from-blue-600 to-teal-500 rounded-3xl p-12 text-center text-white shadow-2xl">
          ...
          <p className="text-xl text-blue-100 mb-8">{t("bookToday")}</p>
          <button
            onClick={onBack}
