...
import { ArrowLeft, SlidersHorizontal, Clock, MapPin, Star, Wifi, Coffee, Snowflake, Monitor, ArrowRight } from 'lucide-react';
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-100 dark:border-gray-700 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <h1 className="text-gray-900 dark:text-white">{t('searchResults')}</h1>
            <button
            ...
            <div className="flex-1">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-gray-600 dark:text-gray-400">TP.HCM → Đà Lạt</div>
                    <div className="text-gray-900 dark:text-white">28/12/2024</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="mb-4">
          <p className="text-gray-600 dark:text-gray-400">
            {t('foundTrips')} <span className="text-blue-600 dark:text-blue-400">{sortedTrips.length} {t('tripsCount')}</span>
          </p>
        </div>
        ...
        <div className="space-y-4">
          {sortedTrips.map((trip) => (
            ...
            >
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-sm text-gray-700 dark:text-gray-300">{trip.rating}</span>
                      </div>
                      <span className="text-sm text-gray-400">({trip.reviewCount} {t('reviews')})</span>
                    </div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-2xl text-blue-600 dark:text-blue-400">{formatPrice(trip.price)}</div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex-1">
                  <div className="text-2xl text-gray-900 dark:text-white mb-1">{trip.departureTime}</div>
                ...
                <div className="flex-1 text-right">
                  <div className="text-2xl text-gray-900 dark:text-white mb-1">{trip.arrivalTime}</div>
