            ...
            {(promo.minAmountVi || promo.minAmountEn) && (
              <div className="flex items-start space-x-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">
                    {language === "vi"
                      ? promo.minAmountVi || "200,000đ"
                      : promo.minAmountEn || "200,000 VND"}
                  </p>
                </div>
              </div>
            )}
            ...
            {(promo.maxDiscountVi || promo.maxDiscountEn) && (
              <div className="flex items-start space-x-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">
                    {language === "vi"
                      ? promo.maxDiscountVi || "100,000đ"
                      : promo.maxDiscountEn || "100,000 VND"}
                  </p>
                </div>
              </div>
            )}
          ...
          {(promo.descriptionVi || promo.descriptionEn) && (
            <div className="space-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                {language === "vi"
                  ? promo.descriptionVi ||
                    "Áp dụng giảm giá cho các tuyến đường đã chọn. Chỉ áp dụng một lần cho mỗi khách hàng."
                  : promo.descriptionEn ||
                    "Apply discount to selected routes. Limited to one use per customer."}
              </p>
            </div>
          )}
            ...
            <ul className="text-sm text-blue-800 dark:text-blue-300 space-y-1 list-disc list-inside">
              ...
              <li>
                {language === "vi"
                  ...
                  : "Non-refundable for ticket cancellations"}
              </li>
              <li>
                {language === "vi"
                  ? "Có hiệu lực đến hết ngày ghi trên mã"
